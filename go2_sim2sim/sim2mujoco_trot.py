...
def run_mujoco(policy, cfg):
    ...
    model = mujoco.MjModel.from_xml_path(cfg.sim_config.mojoco_model_path)
...
if __name__ == '__main__':
    ...
    class Sim2MujocoTrot( Go2TrotCfg ):
        class sim_config:
            mojoco_model_path = args.mujoco_model
            sim_duration = 120.
            dt = 0.001
            decimation = 20
